...
- [AI-WORKLOG-ENFORCEMENT-GUIDE.md](00-guides/02-ai-guides/audit-log/AI-WORKLOG-ENFORCEMENT-GUIDE.md)（必須手順・STOP-GATE）
- [AICQ_Devin_reasoning_log.md](00-guides/02-ai-guides/audit-log/AICQ_Devin_reasoning_log.md)（structured_output スキーマ／Playbook）
- [AI-WORKLOG-IMPLEMENTATION-GUIDE.md](00-guides/02-ai-guides/audit-log/AI-WORKLOG-IMPLEMENTATION-GUIDE.md)（命名規則・回収運用）
...
1. **ENFORCEMENT（必須手順・STOP-GATE）**: [AI-WORKLOG-ENFORCEMENT-GUIDE.md](00-guides/02-ai-guides/audit-log/AI-WORKLOG-ENFORCEMENT-GUIDE.md)
2. **AICQ（structured_output スキーマ／Playbook）**: [AICQ_Devin_reasoning_log.md](00-guides/02-ai-guides/audit-log/AICQ_Devin_reasoning_log.md)
3. **IMPLEMENTATION（回収運用・命名規則）**: [AI-WORKLOG-IMPLEMENTATION-GUIDE.md](00-guides/02-ai-guides/audit-log/AI-WORKLOG-IMPLEMENTATION-GUIDE.md)
4. **PRE-WORK（開始前チェック）**: [AI-PRE-WORK-CHECKLIST.md](00-guides/02-ai-guides/audit-log/AI-PRE-WORK-CHECKLIST.md)
5. **MASTER（全体ワークフロー）**: [AI-MASTER-WORKFLOW-GUIDE.md](00-guides/02-ai-guides/audit-log/AI-MASTER-WORKFLOW-GUIDE.md)
...
また、**作業中も、重要な調査結果・意思決定・前提変更が発生したタイミングで structured_output を更新**し、セッション終了後に messages と合わせて回収・保存すること。**各フェーズにおいて作業のたびに** structured_output を更新し、漏れのない記録を心がけること。**作業の重要・軽微を問わず、すべての作業が監査ログ記録の対象であることに注意すること。**

- **ログ作成の最小合格条件**: メタ情報／依頼原文／不明点／初期計画 を最低限埋めてから作業を開始すること。
  （上記が未記入の場合は、作業ではなく *確認・記入* を優先する）

- 必須手順（STOP-GATE）: [AI-WORKLOG-ENFORCEMENT-GUIDE.md](00-guides/02-ai-guides/audit-log/AI-WORKLOG-ENFORCEMENT-GUIDE.md)
- structured_output スキーマ／Playbook: [AICQ_Devin_reasoning_log.md](00-guides/02-ai-guides/audit-log/AICQ_Devin_reasoning_log.md)
- 回収運用・命名規則: [AI-WORKLOG-IMPLEMENTATION-GUIDE.md](00-guides/02-ai-guides/audit-log/AI-WORKLOG-IMPLEMENTATION-GUIDE.md)
