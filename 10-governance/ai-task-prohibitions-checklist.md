...
以下の高リスク領域に該当する場合、**3条件すべてを満たすか確認**してください:
...
**3条件ゲート**（高リスク領域に該当する場合、すべてYesで通過）:
- [ ] **条件1**: 具体的なファイル名/対象が指定されているか？
- [ ] **条件2**: 変更内容が明確に示されているか？
- [ ] **条件3**: 変更理由が理解できるか？

> **⚠️ 1つでもNoの場合**: 変更せずに確認を求める
> 
> **📌 詳細**: [ai-task-prohibitions.md](./ai-task-prohibitions.md) の「高リスク領域の3条件ゲート」セクションを参照
