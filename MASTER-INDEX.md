...
| 🤖 **AI/Devinユーザー** | [00-guides/02-ai-guides/audit-log/AI-MASTER-WORKFLOW-GUIDE.md](00-guides/02-ai-guides/audit-log/AI-MASTER-WORKFLOW-GUIDE.md) |

### 🛡️ V3.0 監査ログ方式（structured_output＋messages）【必須】

**AI/Devin を使う全作業は、structured_output＋messages の回収（監査ログ化）が必須**です。作業開始前に必ず以下を確認してください。セッション中は **各フェーズ・作業のたびに** structured_output を更新し、完了後に messages と合わせて回収・保存すること。**作業の重要・軽微を問わず、すべての作業が監査ログ記録の対象となる。**

- [AI-WORKLOG-ENFORCEMENT-GUIDE.md](00-guides/02-ai-guides/audit-log/AI-WORKLOG-ENFORCEMENT-GUIDE.md)（必須手順・STOP-GATE）
- [AICQ_AUDIT_LOG_SCHEMA.md](00-guides/02-ai-guides/audit-log/AICQ_AUDIT_LOG_SCHEMA.md)（structured_output スキーマ／イベント対応表）
- [AICQ_Devin_reasoning_log.md](00-guides/02-ai-guides/audit-log/AICQ_Devin_reasoning_log.md)（Playbook／回収・集計モデル／メトリクス定義）
...
| ファイル | サイズ | 内容 |
|---------|-------|------|
| [AI-MASTER-WORKFLOW-GUIDE.md](00-guides/02-ai-guides/audit-log/AI-MASTER-WORKFLOW-GUIDE.md) | 53.2 KB | AI開発ワークフロー総合ガイド 🆕 |
| [AI-PRE-WORK-CHECKLIST.md](00-guides/02-ai-guides/audit-log/AI-PRE-WORK-CHECKLIST.md) | 38.5 KB | AI作業前チェックリスト 🆕 |
...
- Devinユーザー → 00-guides/02-ai-guides/audit-log/AI-MASTER-WORKFLOW-GUIDE.md
