...
特徴:
  - 早期実装による高速検証サイクル
  - 実装後の詳細設計文書化
  - Phase 2.1(事前設計) + Phase 2.2(詳細設計・実装後)
  
実行順序:
  Phase 0 → Phase 1 → Phase 2.1(1-2日) → Phase 3 → Phase 4 → Phase 2.2(並行) → Phase 5
...
実行:
  ...
  Week 2: Phase 3完了 + Phase 4 + Phase 2.2(並行)
  Week 3: Phase 5デプロイ
...
特徴:
  - 実装前に詳細設計を完成
  - 承認プロセスを経てから実装
  - Phase 2.1(事前設計) + Phase 2.2(詳細設計・実装前) + 更新(実装後)
  
実行順序:
  Phase 0 → Phase 1 → Phase 2.1(1-2日) → Phase 2.2(3-5日・実装前) → Phase 3 → Phase 4 → Phase 2.2更新(1日) → Phase 5
...
実行:
  ...
  Week 2: Phase 2.2詳細設計（実装前）
  Week 3-4: Phase 3実装
  Week 5: Phase 4 QA
  Week 6: Phase 2.2更新 + Phase 5デプロイ
...
特徴:
  - Phase 2.1をスキップ
  - 実装優先、ドキュメント後回し
  - Phase 2.2も簡易版または省略可能
  
実行順序:
  Phase 0 → Phase 1 → Phase 3（直接実装） → Phase 4 → Phase 2.2(簡易版・省略可) → Phase 5
