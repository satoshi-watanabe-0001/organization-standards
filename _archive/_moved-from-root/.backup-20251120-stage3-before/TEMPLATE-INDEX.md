...
| 2 | API契約書テンプレート | `01-phase-deliverables/phase-2.1/api-contract-template.yaml` | API仕様の基本定義 | Step 2.1.2 |
| 3 | 制約条件テンプレート | `01-phase-deliverables/phase-2.1/constraints-template.md` | 非機能要件の明確化 | Step 2.1.3 |
...
| 3 | データモデル文書テンプレート | `01-phase-deliverables/phase-5/data-model-template.md` | ER図とスキーマ | Step 2.2.4 |

### 推奨テンプレート

| # | テンプレート名 | ファイル | 用途 | 使用条件 |
|---|--------------|---------|------|---------|
| 4 | 設計レビュー記録 | `02-documents/design-review-template.md` | レビュー結果の記録 | 正式レビュー実施時 |
...
Phase 2.1 → 01-phase-deliverables/phase-2.1/
Phase 3 → 03-code-templates/, 05-testing/
Phase 4 → 02-documents/qa-*, 02-documents/code-review-*
Phase 5 (旧Phase 2B) → 01-phase-deliverables/phase-5/
