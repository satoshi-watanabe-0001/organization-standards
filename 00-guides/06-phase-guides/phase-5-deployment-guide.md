...
### このフェーズ特有の禁止事項
- **本番への直接デプロイ**: ステージング環境での検証なしに本番にデプロイしてはいけない
- **ロールバック計画不足**: ロールバック手順を準備せずにデプロイしてはいけない
- **ダウンタイム通知なし**: メンテナンス通知なしで本番を停止してはいけない
- **デプロイ後検証省略**: デプロイ後の動作検証を省略してはいけない
...
Phase 5を開始・完了する際は、以下のチェックリストを使用してください：

### Phase 5開始前
- [Phase開始前チェックリスト](../../09-reference/checklists/phase-pre-work-checklist.md)

### Phase 5完了時
- [Phase 5 完了チェックリスト](../../09-reference/checklists/phase-5-completion-checklist.md)
