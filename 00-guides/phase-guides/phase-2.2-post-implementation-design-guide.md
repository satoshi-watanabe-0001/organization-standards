---
version: "1.0.0"
last_updated: "2025-11-12 (Phase 2.2 リネーム版)"
status: "draft"
...
# Phase 2.2: 実装後設計ガイド / Post-Implementation Design Guide
...
### このフェーズ特有の禁止事項
- **実装前の作成**: 実装が完了する前にPhase 2.2を実施してはいけない
...
Phase 2.2を開始・完了する際は、以下のチェックリストを使用してください：

### Phase 2.2開始前
- [Phase開始前チェックリスト](../../09-reference/checklists/phase-pre-work-checklist.md)

### Phase 2.2完了時
- [Phase 2.2 完了チェックリスト](../../09-reference/checklists/phase-2.2-completion-checklist.md)
